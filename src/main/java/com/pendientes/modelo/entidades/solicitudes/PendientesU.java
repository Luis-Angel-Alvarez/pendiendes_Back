...
public class PendientesU {
	@JsonProperty("idpendiente")
	@Id
	...
	public PendientesU(int idPendiente, String pendiente, Date fechapendiente) {
		super();
	...
	public PendientesU(String pendiente, Date fechapendiente) {
		super();
		this.pendiente = pendiente;
		this.fechapendiente = fechapendiente;
	}
	public PendientesU(String pendiente) {
		super();
		this.pendiente = pendiente;
	}
